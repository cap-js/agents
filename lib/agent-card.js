...
import { getDescription, getFilteredEntities, getFilteredActions } from "./utils.js"
import { scanSkills, parseAgentMetadata, parseAgentCardMd, parseAgentCardFile } from "./markdown.js"
...
function buildAgentCardFromCardFile(cardMeta, agentMeta, srv, servicePath) {
  ...
  return {
    ...
    capabilities: cardMeta.metadata?.capabilities || { streaming: true, pushNotifications: false },
...
export { generateAgentCard, buildAgentCard, slugified }
