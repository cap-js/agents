...
import { PSEUDONYMIZATION_STATE_CHANNEL } from "../../pseudonymize/store.js"
...
export class CdsCheckpointSaver extends BaseCheckpointSaver {
  ...
  async put(config, checkpoint, metadata) {
    ...
    const pseudoSession = cds.context?._pseudoSession
    if (pseudoSession) {
      prepared.channel_values[PSEUDONYMIZATION_STATE_CHANNEL] = pseudoSession.state()
    }
