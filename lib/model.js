 ...
 * @param {object} [options.params] - Model params (default: cds.env.a2a.params)
...
function createDeepAgentModel(options = {}) {
  ...
  const name = options.name || cds.env.a2a?.llm || process.env.AICORE_MODEL
  const params = options.params || cds.env.a2a?.params
