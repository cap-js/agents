...
function isHiddenElement(name, elem) {
  if (DRAFT_ELEMENTS.includes(name)) return true
  if (LOCALIZED_ELEMENTS.includes(name)) return true
  if (elem["@cds.api.ignore"]) return true
  return false
}
