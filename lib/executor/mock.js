...
module.exports = class MockExecutorService extends cds.Service {
  /**
   * Returns an executor bound to the given CDS service.
   * Mock doesn't use srv, so it returns itself — but the interface
   * is consistent with LangGraphExecutorService.
   */
  for() {
    return this
  }
