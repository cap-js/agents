/**
 * MLflow Databricks span attribute helpers for @cap-js/agent.
 *
 ...
 *
 * All functions return {} when cds.env.agent.mlflow is falsy (zero overhead).
 *
...
export function mlflowAttrs(spanType, opts = {}) {
  if (!cds.env.agent?.mlflow) return {}
