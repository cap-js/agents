...
import { pseudonymizeToolResult } from "../pseudonymize/structured/index.js"
...
function scrubToolOutputs(span) {
  ...
  // forLlm=false: also scrub fields annotated with @Common.Masked (any value including false),
  // because spans must not expose data that is masked in the UI — the LLM-visibility flag
  // is irrelevant here; what matters is that @Common.Masked is present on the element.
