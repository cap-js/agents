    ...
    createMiddleware({
      ...
      afterModel: {
        ...
        hook: (state) => {
          ...
          const isNewTask = taskId && state.quotaTaskId !== taskId
          const prior = isNewTask
            ? { runModelCallCount: 0, runTokenCount: 0, runToolCallCount: 0 }
            : state
          const newCallCount = prior.runModelCallCount + 1
          ...
          const newTokenCount = prior.runTokenCount + consumed
          ...
          const newToolCallCount = prior.runToolCallCount + toolCalls
