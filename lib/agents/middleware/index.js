export default async function buildMiddleware(srv, options = {}) {
  ...
  const { pseudonymizeMiddleware } = await import("./pseudonymize.js")
  ...
  return [
    ...
    pseudonymizeMiddleware(srv), // first — all downstream middleware sees pseudonymized data
