...
export class CdsCheckpointSaver extends BaseCheckpointSaver {
  ...
  async getTuple(config) {
    ...
    const persistAll = cds.env.agent?.persistAllCheckpointWrites === true
   ...
   * Enable cds.env.agent.persistAllCheckpointWrites for custom graphs with parallel branches.
   */
