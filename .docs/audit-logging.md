...
| `AgentInputRequired`             | Agent requests human approval         | `service`, `taskId`, `contextId`, `description`, `interruptData`, `reason`                                                                |
| `AgentTaskCanceled`              | Task canceled                         | `service`, `taskId`, `contextId`, `reason`                                                                                                |
...
| `AgentTaskResumed`               | HITL resume (approve/reject)          | `service`, `taskId`, `contextId`, `decisions`, `reason`                                                                                   |
